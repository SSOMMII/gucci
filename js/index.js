$(document).ready(function(){
    $('.slider').bxSlider({
        ...
        video: false, //slide에 video 사용 및 활성화여부. 반응성 향상, 사용할 시에 plugins/jquery.fitvids.js include 필요
    
        preloadImages: 'all',  // "visible"은 현재 보여지는 슬라이드 이미지만 로드 이후 순차적 로드, "all"로 설정하면 이미지가 모두 로드되야 작동.
        ...
        */
        ...
        //nextSelector: '.next', 기본 next 를 대체할 대상
        //prevSelector: '.prev',  기본 prev 를 대체할 대상
    ...
    $('.hbSlider').bxSlider({
        ...
        ticker: true, //ticker 모드 사용 (speed 조절필요)
        tickerHover: true, //ticker 모드 사용시 마우스 오버로 멈추기.
       ...
       stopAutoOnClick : true, // control 부분 (이전,다음,자동재생 등)과 상호작용시 자동작동 중지.
        ...
        //Carousel method
         ...
         slideWidth : 625, //각 슬라이드 별 width.
         shrinkItems : false, //carousel에 전체 이미지를 다 뿌리고, min, max 수치를 기반으로 뷰포트에 맞게 이미지를 축소
        //accessibility method
        // ariaLive : true, //슬라이더에 Aria Live 속성을 추가.
        //ariaHidden : true, //보이지 않는 슬라이드에 Aria Hidden 속성을 추
        //callBack method는 https://bxslider.com/options/ 참고.
